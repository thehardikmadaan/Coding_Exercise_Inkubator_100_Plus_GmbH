...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\Metadata{
	title= Equity Data Analysis: Working Student Coding Exercise, %Komma hinter dem Titel nicht vergessen ;)
	author= Hardik,
	%	date=2019-04-29,
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\newcommand{\thesisTitel}{Equity Data Analysis: Working Student Coding Exercise}
\newcommand{\authors}{Hardik}
\newcommand{\betreuer}{}
\newcommand{\professor}{}
...
\reviewer{}	%Gutachter: mit \and können weitere Betreuer hinzugefügt werden
\department{} 
\institute{}
\group{}
