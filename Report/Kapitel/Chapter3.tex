...
for _, row in top5.iterrows():
    ...
    if row["isin"] == "XX0000000028":   # Netflix - dashed interpolated segment
        ...
        line, = ax.plot(before["date"], before["indexed"], linewidth=2, label=label)
        ax.plot(bridge["date"], bridge["indexed"], color=line.get_color(), linestyle="--", linewidth=1.5)
        ax.plot(after["date"], after["indexed"], color=line.get_color(), linewidth=2)
    else:
        ax.plot(sw["date"], sw["indexed"], linewidth=2, label=label)
\end{lstlisting}
